		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Aluno 06",
									"targetURL": "#AppFioriAluno06appfiorialuno06-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"AppFioriAluno06appfiorialuno06-display": {
								"semanticObject": "AppFioriAluno06appfiorialuno06",
								"action": "display",
								"description": "Aluno 06 Fiori Application",
								"title": "Aluno 06",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=AppFioriAluno06.appfiorialuno06",
									"url": sap.ui.require.toUrl("AppFioriAluno06/appfiorialuno06")
								}
							}
						}
					}
